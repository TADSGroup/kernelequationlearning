...
if __name__ == '__main__':
    ...
    for i, n_obs in enumerate(N_OBS):
        # IC varies across the sweep (index i) since there's no run-loop left to vary it within a point
        data_list = get_data_for_pinns(n_obs, obs_seed=i, ic_seed=i)
    ...
    print(f'wrote data_in_PINNSR.npy with {len(data_in_PINNSR)} elements (ic_seed=i, one per n_obs index)')
